...
import { selectCurrentUserRoles } from "@/features/auth/selectors";
...
export function DashboardStats() {
  ...
  // Mirrors the backend's role-priority chain in DashboardStatsView.get():
  // system admin > authorizing officer > HR admin > HOD > plain employee.
  ...
  } else if (roles.includes("AUTHORIZING_OFFICER")) {
    cards = [
  ...
  } else if (roles.some((r) => HOD_ROLES.includes(r))) {
    cards = [
