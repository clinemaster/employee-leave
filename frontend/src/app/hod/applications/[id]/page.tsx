...
import { HodRecommendationForm } from "@/components/workflow/HodRecommendationForm";
import { useGetLeaveApplicationQuery } from "@/features/leave/leaveApi";

export default function HodApplicationDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
